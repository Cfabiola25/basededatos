...
class EventsAgendaSeeder extends Seeder
{
    public function run(): void
    {
        ...
        // Definimos los IDs que usas abajo
        $AGENDA_ID = $agenda->id;
        ...
        */
        ...
        if ($jornadaMiercoles) {
            ...
            $itemsMiercoles = [
                // 08:00 – 09:00 (Conferencias – Hotel CasaBlanca / FESC)
                ...
                [ 'title'=>'Modelos de Desarrollo Turístico Rentables y Sostenibles, Caso Sierra de Santamarta','category_id'=>$CAT_CONFERENCIAS, 'location_id'=>$LOC_HOTEL_CASABLANCA, 'place'=>'Salón Rubí',         'program'=>null, 'time'=>'08:00 a.m. - 09:00 a.m.' ],
                ...
                // Actividad cultural (Cine) – mañana
                [ 'title'=>'4° FESCtival Internacional de Cine Universitario de Cúcuta - Concurso de Cortometrajes (Mañana)',   'category_id'=>$CAT_EVENTOSESPECIALES, 'location_id'=>$LOC_QUINTA_TERESA, 'place'=>'Sala de Proyección', 'program'=>null, 'time'=>'08:00 a.m. - 12:00 m.' ],

                // 15:00 – 18:00 (WORKSHOPS – FESC)
                ...
                [ 'title'=>'Fase 2. Prototipado y Validación de Soluciones Empresariales',                                     'category_id'=>$CAT_WORKSHOPS, 'location_id'=>$LOC_FESC, 'place'=>'Aula (FESC)', 'program'=>null, 'time'=>'03:00 p.m. - 06:00 p.m.' ],

                // 15:00 – 17:00 (Mesa Redonda – Hotel CasaBlanca)
                ...
                // Actividad cultural (Cine) – tarde
                [ 'title'=>'4° FESCtival Internacional de Cine Universitario de Cúcuta - Concurso de Cortometrajes (Tarde)',    'category_id'=>$CAT_EVENTOSESPECIALES, 'location_id'=>$LOC_QUINTA_TERESA, 'place'=>'Sala de Proyección','program'=>null,'time'=>'02:00 p.m. - 06:00 p.m.' ],

                // 19:00 – 20:00 (Conferencias – noche)
                ...
                // Virtuales (se manejan como FESC + place Virtual)
                ...
                // 20:15 – 21:15 (Conferencia de cierre del día)
            ...
            foreach ($itemsMiercoles as $e) {
                EventsAgenda::create([
                    'uuid'=>Str::uuid(), 'agenda_id'=>$AGENDA_ID, 'jornada_id'=>$JORNADA_ID,
                    'category_id'=>$e['category_id'], 'location_id'=>$e['location_id'], 'place'=>$e['place'],
                    'title'=>$e['title'], 'program'=>$e['program'], 'time'=>$e['time'],
